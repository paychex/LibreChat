        ...
        .map((item, index) => {
          ...
          if (subItems && subItems.length > 0) {
            return (
              ...
              >
                <Ariakit.MenuButton
                  className={cn(
                    'group flex w-full cursor-pointer items-start justify-between gap-2 rounded-lg px-3 py-3.5 text-sm text-text-primary outline-none hover:bg-surface-hover focus:bg-surface-hover md:px-2.5 md:py-2',
                    itemClassName,
                  )}
          ...
          return (
            <Ariakit.MenuItem
              ...
              id={item.id}
              className={cn(
                'group flex w-full cursor-pointer items-start gap-2 rounded-lg px-3 py-3.5 text-sm text-text-primary outline-none hover:bg-surface-hover focus:bg-surface-hover md:px-2.5 md:py-2',
                itemClassName,
                item.className,
              )}
              disabled={item.disabled}
