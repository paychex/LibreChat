...
setup_environment() {
    ...
    echo "     AZURE_OPENAI_BASEURL=https://service-internal-n2a.paychex.com/is/librechat/azure/openai/deployments/\${DEPLOYMENT_NAME}"
    ...
    echo "     RAG_AZURE_OPENAI_ENDPOINT=https://service-internal-n2a.paychex.com/is/librechat/azure/"
