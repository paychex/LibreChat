...
output "private_endpoint_key_vault_id" {
  ...
  value       = var.enable_private_endpoints ? module.private_endpoint_key_vault[0].id : null
}

output "private_endpoint_key_vault_ip" {
  description = "Private IP address of the Key Vault private endpoint"
  value       = var.enable_private_endpoints ? module.private_endpoint_key_vault[0].private_ip_address : null
}

output "private_endpoint_storage_id" {
  description = "ID of the Storage private endpoint"
  value       = var.enable_private_endpoints ? module.private_endpoint_storage[0].id : null
}

output "private_endpoint_storage_ip" {
  description = "Private IP address of the Storage private endpoint"
  value       = var.enable_private_endpoints ? module.private_endpoint_storage[0].private_ip_address : null
}
